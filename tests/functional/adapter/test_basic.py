...
class TestSimpleMaterializationsTiDBCloudLake(BaseSimpleMaterializations):
    pass


#
class TestEmptyTiDBCloudLake(BaseEmpty):
    pass


class TestBaseAdapterMethodTiDBCloudLake(BaseAdapterMethod):
    pass


#
#
# class TestEphemeralTiDBCloudLake(BaseEphemeral):
#     pass


class TestIncrementalTiDBCloudLake(BaseIncremental):
    pass
